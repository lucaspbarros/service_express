...
<body class="bg-cinza">
  ...
  <nav class="navbar navbar-expand-lg  navbar-light bg-light sticky-top m-0">
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-12">
        ...
        <div class="col-md-12">
          ...
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic voluptates error, atque sint aliquid quas recusandae consequuntur similique culpa amet repellendus, itaque dolores iusto voluptate, aut nulla nostrum dolorum dicta?</p>
  ...
  <footer class="bg-cinza container-fluid py-5">
    <div class="row">
      <div class="col-md-3">
        <ul>
